...
Functions in TBASIC can take \emph{argument}s. Arguments are the values you pass to functions. Functions can take one or more arguments. If the function only requires single argument, you can call the function with an argument without parentheses, like \mono{GOTO 30}, but if the function takes two or more arguments, they must be surrounded with parentheses, such as \mono{PRINT("HL", 3, "CONFIRMED")}.
