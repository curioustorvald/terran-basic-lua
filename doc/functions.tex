...
\subsection{LABEL} \emph{name} --- creates alias for the current line number, so that they can be used with \code{GOTO} or \code{GOSUB} commands
...
\subsection{LOAD} \emph{path} --- loads the file as a command. Previously entered commands will be deleted (shell function)
